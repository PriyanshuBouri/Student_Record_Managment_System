...
void acceptdata()
{
    ...
    cin>>s.roll;
    cout<<"ENTER YOUR PROGRAMMING MARK :"; // math 
    cin>>s.pro;
    cout<<"ENTER YOUR COMPUTER ARCITECTURE MARK :"; // chem 
    cin>>s.arc;
    cout<<"ENTER YOUR WRITING SKILL MARK :"; // phy 
    cin>>s.writing;
    cout<<"ENTER YOUR ALGEBRA MARK :"; // bio 
    cin>>s.alg;
